// Sample user queries for testing the query disambiguation system
...
export const QUERY_INPUT_PLACEHOLDER = "e.g., track media coverage";
...
export const USER_QUERIES: UserQuery[] = [
  ...
  // Querys that map to overlapping nodes (pre-rationalized duplicates)
  {
  ...
  // Querys that map to workflow nodes
  {
