...
export const FUNCTIONAL_NODES: Record<string, FunctionalNode> = {
  ...
  'product-core-banking': {
    ...
    label: 'CoreBanking',
    level: 'product',
    children: ['outcome-accounts-cb', 'outcome-transactions-cb'],
    parents: []
  },
  'product-wealth': {
    id: 'product-wealth',
    label: 'WealthManager',
    level: 'product',
    children: ['outcome-investments-wealth', 'outcome-planning-wealth'],
    parents: []
  },
  'product-loans': {
    id: 'product-loans',
    ...
    level: 'product',
    children: ['outcome-origination-loans', 'outcome-servicing-loans'],
    parents: []
  },
  'product-payments': {
    id: 'product-payments',
    label: 'PaymentHub',
    level: 'product',
    children: ['outcome-processing-payments', 'outcome-merchant-payments'],
    parents: []
  },
  'product-risk': {
    id: 'product-risk',
    label: 'RiskAnalytics',
    level: 'product',
    children: ['outcome-compliance-risk', 'outcome-monitoring-risk'],
    parents: []
  },
  ...
  'scenario-open-account-cb': {
    ...
    level: 'scenario',
    products: ['core-banking'],
    children: ['step-collect-info-cb', 'step-verify-identity-cb', 'step-verify-identity-shared'],
  ...
  'scenario-kyc-risk': {
    ...
    level: 'scenario',
    products: ['risk'],
    children: ['step-identity-verification-risk', 'step-background-check-risk', 'step-verify-identity-shared'],
  ...
  'action-check-documents-cb': {
    ...
    children: [],
    parents: ['step-verify-identity-cb', 'step-verify-identity-shared']
  },
  ...
  'action-check-id-documents-risk': {
    ...
    children: [],
    parents: ['step-identity-verification-risk', 'step-verify-identity-shared']
  },
  ...
  'step-verify-identity-shared': {
    id: 'step-verify-identity-shared',
    label: 'Verify Customer Identity',
    level: 'step',
    products: ['core-banking', 'risk'],
    children: [
      // Union of children from step-verify-identity-cb and step-identity-verification-risk
      'action-check-documents-cb',
      'action-validate-id-cb',
      'action-check-id-documents-risk',
      'action-verify-biometrics-risk'
    ],
    parents: ['scenario-open-account-cb', 'scenario-kyc-risk'] // Parents from both duplicate nodes
  }
};